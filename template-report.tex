...
\vspace{-1.5cm}\noindent\includegraphics[height=6ex]{pics/logo_IM2AG.jpeg}\hfill{\includegraphics[height=6ex]{pics/logo_Ensimag.jpeg}}\\
\bigskip
\begin{center} \large
...
\author{Your Name}
\date{Defense Date, 2023} % Delete this line to display the current date
\jury{
...
\SingleSpace
%==============================CHAPTERS==================
\include{./chapters/0_preliminaries}

\include{./chapters/3_experiments}
\include{./chapters/4_stuff}
